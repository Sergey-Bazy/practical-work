...
// let spl = dates.split("/")
// let at = dates.replace(/\d{1,2}\/\d{1,2}\/\d{4}/)
let re = dates.replace(/\./g,"/");
let two = re.replace(/^/g," ");
// let twoRe = re.replace(/\s/g,",")
// let threRe = twoRe.replace(//g)
// let spl = twoRe.split("-")
// let re = dates.replace(/\D\S/g,"/") ;
// let re2 = re.replace(/ /g)
console.log(two)
// console.log(spl)
// dates.split(re);
// console.log(dates)
