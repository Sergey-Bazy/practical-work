...
// let b = a[a.length - 1];
// console.log(b.tagName.toLowerCase())
...
// let a = document.querySelector(".price");
// a = a.textContent = a.textContent * 2;
...
// let a = document.querySelector(".content").querySelector("p");
...
let num = document.querySelectorAll(".numeric");
console.log(num);
let arr = num.forEach((elem) => {
  if (+elem.innerText < 0) {
    elem.innerText = "<b>" + elem.textContent + "</b>";
  }
});


let result = document.querySelectorAll(".numeric");
...
// new_element.textContent = "Ура! Мой скрипт отработал верно!";
// let du = document.querySelector("#root");
// du.appendChild(new_element);
...
// let du = document.querySelector(".content");
// du.appendChild(new_element);
...
// new_element.textContent = "Велосипед";
// let du = document.querySelector("ul");
// let firstLl = document.querySelector('li');
// du.insertBefore(new_element,firstLl);
...
// let newId = document.querySelectorAll("div");
// newId.forEach(elem =>  elem.className = "adds");
...
// let newId = document.querySelectorAll("p");
// newId.forEach(elem =>  elem.id = "p_1");
...
// let newId = document.querySelectorAll("p");
// newId.forEach(elem =>
// { if(elem.textContent == 15 || elem.textContent == 20 || elem.textContent == 25 ){
//      elem.remove()}});
...
// let new_element = document.createElement("li");
// let tagFirstNamme = document.querySelector("#first");
// tagFirstNamme.appendChild(new_element);
...
// let firstDiv = document.querySelectorAll("p");
// let secondDiv = document.querySelector("#div2");

// firstDiv.forEach((elem) => {
//   if (
//     elem.textContent == "велосипед" ||
//     elem.textContent == "ролики" ||
//     elem.textContent == "лыжи"
//   ) {
//     secondDiv.appendChild(elem);
//   }
// });
...
// let elm = document.querySelector("#div_elem");
